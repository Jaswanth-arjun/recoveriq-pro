...
const TITLE = "GreenBasket — Build your own fresh morning basket";
const DESCRIPTION =
  "An immersive 3D organic store: travel through eight farm worlds, pick what you want and how much, and see your daily basket and monthly subscription price update live.";
...
function GreenBasket() {
  ...
  return (
    <main className="relative h-screen w-screen overflow-hidden text-ink">
