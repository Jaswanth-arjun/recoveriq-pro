...
export function Intro({ onStart }: { onStart: () => void }) {
  ...
  // Ultra-smooth 60/120fps GPU parallax using requestAnimationFrame & CSS variables (0 React re-renders)
  useEffect(() => {
  ...
  return (
    ...
    >
      {/* Dynamic Ambient Sunbeam / Lens Flare that tracks cursor via CSS vars */}
      <div
      ...
      {/* Dynamic Background Image Layer with 3D Tilt & Parallax */}
      <div className="absolute inset-0 -z-10 overflow-hidden bg-[#e0be7d]">
        ...
        >
          <img
            ...
            loading="eager"
          />
          {/* Subtle Vignette & Warm Tint Gradient */}
          <div
      ...
      {/* EXACT MIDDLE HERO CONTENT SECTION */}
      <div className="relative z-20 flex flex-1 flex-col items-center justify-center px-6 text-center my-auto py-10 h-full">
        ...
        >
          ...
          {/* ELEGANT & SMOOTH HERO TITLE - 100% Glitch-Free on Refresh */}
          <h1
          ...
          {/* Action Button & Floating Feature Badges */}
          <div
      ...
      {/* Organic Wave Transition Edge at the Bottom */}
