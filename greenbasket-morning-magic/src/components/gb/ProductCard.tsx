...
import { DELIVERY_DAYS_PER_MONTH, formatINR, MAX_QUANTITY, type Product } from "@/data/products";
...
export function ProductCard({ product, index }: { product: Product; index: number }) {
  ...
  // Local quantity selection BEFORE adding to bag
  ...
  // Handle explicit Add to Bag button click
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex items-center justify-between gap-2 border-t border-white/40 pt-3">
        {/* Quantity Stepper: Controls local quantity if unadded, or basket quantity if added */}
        <QuantityStepper
        ...
        {/* Action Button: Explicit "Add to bag" button when not in bag, or "In Bag" status when added */}
        {isAdded ? (
