...
export function CategoryPanel({
  ...
  // Ultra-fast RAF parallax running ONLY when panel is active (0 React re-renders)
  useEffect(() => {
    if (!active) return;
  ...
  return (
    ...
    >
      {/* 3D High-Res Background World Layer with RAF Parallax */}
      <div className="absolute inset-0 -z-10 overflow-hidden bg-black/40">
        ...
        >
          <img
            ...
            loading="lazy"
          />
          {/* Subtle Dynamic Ambient Lighting Tint */}
          <div
      ...
      {/* Main Responsive Multi-Column Glassmorphism Storefront Container */}
      <div className="glass-panel relative z-20 flex max-h-[85vh] w-full max-w-6xl flex-col overflow-hidden rounded-[28px] shadow-2xl border border-white/70 bg-white/75 backdrop-blur-xl transition-all duration-300">
        ...
        {/* Scrollable Product Listing Container - Optimized Responsive Multi-Column Grid */}
        <div
          ref={scroller}
          onScroll={onScroll}
          data-inner-scroll
        ...
        {/* Footer indication to scroll down */}
