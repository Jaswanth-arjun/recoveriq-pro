...
export function FloatingBag({ hidden }) {
  ...
  return (
    <button
      ...
      className="glass-panel fixed bottom-5 right-5 z-40 w-[13.5rem] rounded-3xl px-5 py-4 text-left transition-transform duration-300 hover:-translate-y-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-leaf sm:bottom-8 sm:right-8 cursor-pointer"
    >
